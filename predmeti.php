...
<div class="container">
    <div class="content row">
        ...
        <div class="main-content col-md-9 col-12">
            <h2>Предметы в учебном заведении</h2>
            <div class="row title-table ">
                <div class="col-6">Название предмета</div>
                <div class="col-6">ФИО преподавателя</div>
            </div>
            <hr>
            <?php foreach ($predmeti as $predmet): ?> 
                <hr> <div class="row post">
                        <!-- <div class="col-1"><a href="#id=<?=$student['id'];?>"><?=$student['id'];?></a></div> -->
                        <div class="col-6 text-center"><?=$predmet['name'];?></div>
                        <div class="col-6 text-center"><?=$predmet['fio_prepod']; ?></div>
                    </div><hr> 
                    <?php endforeach; ?>
