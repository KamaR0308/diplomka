...
<div class="container">
    <div class="content row">
        ...
        <div class="main-content col-md-9 col-12">
            <h2>Препадователи в учебном заведении</h2>
            <div class="row title-table ">
                
                <div class="col-4 text-center">ФИО препадователя</div>
                <div class="col-4 text-center">Дата рождения</div>
                <div class="col-4 text-center">Номер телефона</div>
            </div>
            <hr>
            <?php foreach ($prepadovateli as $prepadovatel): ?> 
                <hr><div class="row post">
                        <div class="col-4 text-center"><?=$prepadovatel['fio_prepod'];?></div>
                        <div class="col-4 text-center"><?=$prepadovatel['dateofbirthday'];?></div>
                        <div class="col-4 text-center"><?=$prepadovatel['phone'];?></div>
                    </div><hr>
                    <?php endforeach; ?>
