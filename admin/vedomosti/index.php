...
<?php include "../../app/include/sidebar-admin.php"; ?>
        ...
        <div class="posts col-10">
            ...
            <div class="button ">
                    <a href="<?php echo BASE_URL . "admin/vedomosti/create.php";?>" class="col-2 btn btn-success">Создать</a>
            ...
            <div class="row title-table ">
                ...
                <div class="col-1 text-center">Группа</div>
                <div class="col-2 text-center">Студент ФИО</div>
                <div class="col-2 text-center">Предмет</div>
                <div class="col-2 text-center">Преподаватель ФИО</div>
                <div class="col-1 text-center">Оценка </div>
                <div class="col-2 text-center">Управление записью </div>
