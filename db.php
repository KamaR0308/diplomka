...
if(isset($_POST['submit'])){
  ...
  echo ' <hr><div class="row  text-center"><div class=" col-1 text-center">'.$row['semestr'] .'</div> <div class="col-2 text-center">'.$row['gruppa'].'</div> <div class="col-3 text-center">'.$row['fio_stud'].'</div> <div class="col-2 text-center">'.$row['name'].'</div> <div class="col-3 text-center">'.$row['fio_prepod'].'</div> <div class="col-1 text-center">'.$row['ocenka'].'</div>
  </div><hr>';
}
else {
